...
gst_video_ancillary_di_d16_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_ANCILLARY_DID16_S334_EIA_708, "GST_VIDEO_ANCILLARY_DID16_S334_EIA_708", "708" },
      { GST_VIDEO_ANCILLARY_DID16_S334_EIA_608, "GST_VIDEO_ANCILLARY_DID16_S334_EIA_608", "608" },
      { 0, NULL, NULL }
    };
