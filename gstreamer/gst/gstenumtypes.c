...
GType
gst_gap_flags_get_type (void)
{
static gsize gtype_id = 0;
static const GFlagsValue values[] = {
    { C_FLAGS(GST_GAP_FLAG_MISSING_DATA), "GST_GAP_FLAG_MISSING_DATA", "data" },
{ 0, NULL, NULL }
        };
        if (g_once_init_enter (&gtype_id)) {
            GType new_type = g_flags_register_static (g_intern_static_string ("GstGapFlags"), values);
            g_once_init_leave (&gtype_id, new_type);
        }
        return (GType) gtype_id;
        }
...
static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_SEEK_FLAG_FIRST_FRAME), "GST_SEEK_FLAG_FIRST_FRAME", "first_frame" },
#endif
{ 0, NULL, NULL }
        };
        if (g_once_init_enter (&gtype_id)) {
...
#ifdef OHOS_OPT_PERFORMANCE
    // ohos.opt.performance.0006: the pts segment of the first frame is calibrated to improve the performance
    { C_FLAGS(GST_SEGMENT_FLAG_FIRST_FRAME), "GST_SEGMENT_FLAG_FIRST_FRAME", "first_frame" },
#endif
{ 0, NULL, NULL }
        };
        if (g_once_init_enter (&gtype_id)) {
...
GType
gst_serialize_flags_get_type (void)
{
static gsize gtype_id = 0;
static const GFlagsValue values[] = {
    { C_FLAGS(GST_SERIALIZE_FLAG_NONE), "GST_SERIALIZE_FLAG_NONE", "none" },
    { C_FLAGS(GST_SERIALIZE_FLAG_BACKWARD_COMPAT), "GST_SERIALIZE_FLAG_BACKWARD_COMPAT", "backward-compat" },
{ 0, NULL, NULL }
        };
        if (g_once_init_enter (&gtype_id)) {
            GType new_type = g_flags_register_static (g_intern_static_string ("GstSerializeFlags"), values);
            g_once_init_leave (&gtype_id, new_type);
        }
        return (GType) gtype_id;
        }
